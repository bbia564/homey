...
class HomeSecondLogic extends GetxController {

  DBHome dbHome = Get.find<DBHome>();

  var warning = true.obs;
  ...
  aboutHomePrivacy(BuildContext context) async {
...
If you have any questions or concerns about our privacy policy, please contact us via email.
  ...
  aboutHomeUS(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      children: [
        const Text(
            """We can keep track of your home medicines"""),
      ],
      context: context,
    );
  }
